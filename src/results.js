...
export const updateCount = () => {
  if (RUN.tick < TOTAL_TICKS) {
    ...
    if (RUN.results[STATES.infected] + RUN.results[STATES.symptoms] + RUN.results[STATES.alerted] > RUN.results['max-concurrent-infected']) {
      RUN.results['max-concurrent-infected'] = RUN.results[STATES.infected] + RUN.results[STATES.symptoms] + RUN.results[STATES.alerted]
    }
